...
/**
 * View dedicada ao fluxo de cadastro de um novo Passageiro.
 */
public class CadastroPassageiroView {
    ...
    /**
     * Executa o fluxo de cadastro de um novo passageiro com validação de campos.
     */
    public static void executar() {
        ...
        passageiroService.criar(nome, email, senha, cpf, telefone);
